  ...
  return (
    <div>
      <div className={styles.container}>
        <form className={style.form} onSubmit={(event) => submitHandlerModify(event)}>
          <h1>Modify</h1>
          ...
          <div className={style.inputText}>
            ...
            <div className={style.inputNumber}>
                <label>Health:</label>
                <input type="range" min={1} max={100} name="life" value={formModify.life}
            ...
            <div className={style.inputNumber}>
                <label>Attack:</label>
                <input type="range" min={1} max={100} name="attack" value={formModify.attack}
                onChange={(event) => changeHandlerModify(event)} 
                className={style.bar}/>
            ...
            <div className={style.inputNumber}>
                <label>Defense:</label>
                <input type="range" min={1} max={100} name="defense" value={formModify.defense}
                onChange={(event) => changeHandlerModify(event)} 
                className={style.bar}/>
            ...
            <div className={style.inputNumber}>
                <label>Speed:</label>
                <input type="range" min={1} max={100} name="speed" value={formModify.speed}
                onChange={(event) => changeHandlerModify(event)} 
                className={style.bar}/>
            ...
            <div className={style.inputNumber}>
                <label>Height:</label>
                <input type="range" min={1} max={100} name="height" value={formModify.height}
                onChange={(event) => changeHandlerModify(event)} 
                className={style.bar}/>
            ...
            <div className={style.inputNumber}>
                <label>Weight:</label>
                <input type="range" min={1} max={100} name="weight" value={formModify.weight}
                onChange={(event) => changeHandlerModify(event)} 
                className={style.bar}/>
            ...
            <div className={style.inputText}>
                <label>Image:</label>
                <input type="text" name="image" value={formModify.image}
                onChange={(event) => changeHandlerModify(event)} placeholder="url"/>
            </div>
