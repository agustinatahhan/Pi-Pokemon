const validation = (input) => {
  ...
  if (!/\.(jpeg|jpg|gif|png|bmp|svg)$/i.test(input.image))
    errors.image = "Enter Url Image";
  ...
  if (input.speed <= 0 || input.speed > 100)
    errors.speed = "Speed must be greater than 0 and less than or equal to 100";
  ...
  if (input.attack <= 0 || input.attack > 100)
    errors.attack =
      "Attack must be greater than 0 and less than or equal to 100";
  ...
  if (input.defense <= 0 || input.defense > 100)
    errors.defense =
      "Defense must be greater than 0 and less than or equal to 100";

  // if(!input.life) errors.life = "You need to add some life";
  // if (!/^\d+$/.test(input.life)) errors.life = "Life must contain only numbers";
  if (input.life <= 0 || input.life > 100)
    errors.life = "Life must be greater than 0 and less than or equal to 100";
  ...
  if (input.height <= 0 || input.height > 100)
    errors.height =
      "Height must be greater than 0 and less than or equal to 100";
